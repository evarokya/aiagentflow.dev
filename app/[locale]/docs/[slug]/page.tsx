...
export default function DocPage({ params }: DocPageProps) {
    ...
    return (
        <div className="flex flex-col lg:flex-row w-full max-w-[1400px] mx-auto relative">
            ...
            {/* Main Content Area */}
            <div className="flex-1 min-w-0 py-16 md:py-24 px-6 md:px-16 lg:px-20 relative z-10">
                <article>
            ...
            <div className="hidden xl:block w-72 py-24 px-8 sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto">
                <TableOfContents />
            </div>
        </div>
    );
