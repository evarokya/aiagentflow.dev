                ...
                <div className="flex-1 min-w-0 py-16 md:py-32 px-6 md:px-16 lg:px-24">
                    <article>
                        <div className="prose prose-invert prose-slate prose-lg md:prose-xl max-w-none 
                            ...
                            prose-pre:bg-[#09090b] prose-pre:border prose-pre:border-white/10 prose-pre:shadow-2xl prose-pre:rounded-[2rem]">
                            <ReactMarkdown
                        ...
                        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-6">
                            {prevPost ? (
                                <Link
                                    ...
                                    className="group flex flex-col gap-3 p-10 rounded-[2.5rem] bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5 hover:border-brand-primary/30 transition-all text-left"
                                >
                            ...
                            {nextPost ? (
                                <Link
                                    ...
                                    className="group flex flex-col gap-3 p-10 rounded-[2.5rem] bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/5 hover:border-brand-primary/30 transition-all text-right"
                                >
                        ...
                        <div className="mt-24 p-12 md:p-20 rounded-[3rem] bg-slate-900 text-white relative overflow-hidden group">
                            ...
                            <div className="relative z-10 text-center">
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                                    <Link href="/" className="px-10 py-5 rounded-full bg-white text-slate-950 font-black text-xl hover:scale-105 transition-all shadow-2xl">
                                        Get Started Free
                                    </Link>
                                    <a href="https://github.com/aiagentflow/aiagentflow" className="px-10 py-5 rounded-full bg-white/10 font-bold border border-white/20 hover:bg-white/20 transition-all text-lg">
                                        Star on GitHub
                                    </a>
                                </div>
                            </div>
