                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                <div className="text-xl font-bold mb-1">Make your first contribution</div>
                                <div className="text-white/80 text-sm italic">Documentation | Bug Fixes | Feature Requests</div>
                            </div>
                        </motion.div>
                    </div>
                </div>
